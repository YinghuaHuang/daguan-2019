...
class BilstmSeqTagger(onmt.models.SequenceTagger):
    """bidirectional LSTM-CRF """
    def __init__(self):
        super(BilstmSeqTagger,self).__init__(
            inputter=onmt.inputters.WordEmbedder(
                vocabulary_file_key="source_words_vocabulary",
                embedding_size=None,
                embedding_file_key="source_embedding",
            ...
            tagging_scheme="BIO",
            crf_decoding=True,
            name="bilstm_sequence_tagger"
        )

class TransformerSeqTagger(onmt.models.SequenceTagger):
    """Transformer-CRF """
    def __init__(self):
        super(TransformerSeqTagger,self).__init__(
            ...
            tagging_scheme="BIO",
            crf_decoding=True,
            name="transformer_sequence_tagger"
        )

class TransformerMaskLM(onmt.models.SequenceTagger):
    """Transformer-CRF """
    def __init__(self):
        super(TransformerMaskLM,self).__init__(
            inputter=onmt.inputters.MaskedWordEmbedder(
                vocabulary_file_key="source_words_vocabulary",
                embedding_size=512,
                dropout = 0.1,
                trainable=True),
